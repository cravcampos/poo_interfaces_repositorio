...
import com.cravcampos.poointerfaces.repositorio.*;
...
public class EjemploRepositorio {
    ...
    public static void main(String[] args) {
        ...
        List<Cliente> paginable = ((PaginableRepositorio)repo).listar(0,5);
        paginable.forEach(System.out::println);

        System.out.println("====================== Imprimiendo orden ascendente=========================");
        List<Cliente> clientesOrdenAscendente = ((OrdenableRepositorio)repo).listar("nombre", Direccion.ASC);
        for (Cliente c: clientesOrdenAscendente){
            System.out.println(c);
        }

        System.out.println("====================== Imprimiendo orden descendente=========================");
        List<Cliente> clientesOrdenDescendente = ((OrdenableRepositorio)repo).listar("apellido", Direccion.DESC);
